  ...
  return (
    <div className="trans-list-page-container">
      <div className="header-container">
        ...
        <Link to="/create" className="nav-link mf-6"><button className="btn my-buttons btn btn-secondary">Create</button></Link>
        </div>
        </div>
        ...
        <tbody>
          {transaction.map(trans => (
            <tr key={trans._id}>
              ...
              <td><button className='btn btn-danger' onClick={deleteData(trans._id)}>Delete</button></td>
            </tr>
          ))}
        </tbody>
      </table>
